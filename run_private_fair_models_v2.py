...
def test(data, fair_choice, sigma, C, seed ):
    ...
    file_name = file_path + '{}_private_fair_{}_choice_C_{}_sigma_{}_seed_{}_v2.pkl'.format(data, fair_choice, C, sigma,
                                                                                            seed)
    ...
    options = {'dp': True, 'clip_norm': False, 'lr': 1e-3, 'C': C, 'sigma': sigma, 'epochs': num_epochs,
               'lambda_': [0.0] * 10,
               'mult_lr': None, 'clf': True, 'noise_rng': None, 'device': 'cpu', 'C_2': -2, 'fair_choice': fair_choice,
               'delta': 1e-5, \
